; ============================================================================
;  EmailSender - Inno Setup script (x64)
;  Requires Inno Setup 6.2+.  Compile with:  ISCC.exe EmailSender-x64.iss
...
LicenseFile=LICENSE
OutputDir=Setup
OutputBaseFilename=EmailSender-{#MyAppVersion}-x64
Compression=lzma2
SolidCompression=yes
WizardStyle=modern
; Only run on 64-bit (x64) Windows and install into the native 64-bit folders.
